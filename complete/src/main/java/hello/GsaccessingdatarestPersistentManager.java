...
public class GsaccessingdatarestPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Gsaccessingdatarest";
	...
	private GsaccessingdatarestPersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(hello.Person.class);
		configuration.addAnnotatedClass(hello.Company.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new GsaccessingdatarestPersistentManager();
		}
